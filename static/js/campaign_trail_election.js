$(document).ready(function () {
  ...
  var temp_get_state_result_html = function (data) {
    var response_html =
      "<table><tr><th>Candidate</th><th>PV Avg.</th><th>PV % Avg.</th><th>EV Avg.</th><th>Win %</th><th>PV Range</th></tr>";
  ...
  var temp_get_overall_result_data = function () {
    ...
    var response_html =
      "<table><tr><th>Candidate</th><th>Win %</th><th>EV Avg.</th><th>PV Avg.</th><th>PV % Avg.</th><th>EV Range</th><th>PV Range</th></tr>";
    for (var i = 0; i < data.length; i++) {
      response_html +=
        '<tr><td style="text-align: left;"><span style="background-color: ' +
        data[i]["color_hex"] +

...
!(function () {
  ...
  function b() {
    ...
    var r =
      ...
      "</table>" +
      l +
      '</div> <div id="overall_election_details"> <h4>Results - Historical</h4> <table> <tbody> <tr> <th>Candidate</th> <th>Electoral Votes</th> <th>Popular Votes</th> <th>Popular Vote %</th> </tr> <tr> <td style="text-align: left;"><span style="background-color:' +
      HistHexcolour[0] +
      "; color:" +
      HistHexcolour[0] +
      ';">----</span>' +
      ...
      "</td> <td>" +
      HistPVP[0] +
      '</td> </tr> <tr> <td style="text-align: left;"><span style="background-color:' +
      HistHexcolour[1] +
      "; color:" +
      HistHexcolour[1] +
      ';">----</span>' +
      ...
      "</td> <td>" +
      HistPVP[3] +
      '</td> </tr> </tbody> </table><p><b><a style="font-size:15px;" href="' +
      game_url +

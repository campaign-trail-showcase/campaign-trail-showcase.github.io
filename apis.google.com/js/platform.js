...
*/
  ...
  da("Symbol", function (a) {
    ...
    var b = function (e, f) {
      this.ca = e;
      aa(this, "description", { configurable: !0, writable: !0, value: f });
    };
  ...
  var Ta = function (a) {
      if (a instanceof x && a.constructor === x && a.da === Sa) return a.S;
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  var ue = { se: "0" },
    ...
    ze = function (a, b, c) {
      ...
      c = {};
      for (var l in f)
        G(f, l) && k.test(l) && ((c[l.replace(k, "")] = f[l]), delete f[l]);
...
gapi.load("", {
  ...
  _c: {
    jsl: {
      ...
      h: "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_US.MWM3Xj_RD9s.O/am\u003dAQ/d\u003d1/ct\u003dzgms/rs\u003dAGLTcCOUmnuCcTtedasW7L1tq37fs4eoIg/m\u003d__features__",
